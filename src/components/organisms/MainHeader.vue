...
<template>
  <header
    class="sticky top-0 z-[100] w-full font-sans text-text-main bg-white/80 backdrop-blur-md shadow-[0_10px_25px_rgba(14,13,11,0.05),inset_0_1px_0_rgba(255,255,255,0.6)] border border-white/80 rounded-3xl lg:rounded-none lg:border-none lg:shadow-[0_10px_25px_rgba(14,13,11,0.05)]"
  >
    <!-- Main nav container: full-width bg, centered content up to 1440px, counter body p-2 -->
    <div class="mx-auto flex h-[72px] max-w-[1440px] items-center justify-between -mx-2 px-8 lg:h-[100px] lg:-mx-0 lg:px-8 xl:px-16">
      <!-- Logo -->
      <a href="#" aria-label="Homepage" class="flex-shrink-0">
        <BrandLogo />
      </a>
      ...
      <div class="hidden lg:flex items-center justify-center gap-10 flex-1">
        ...
        <!-- Desktop CTA -->
        <BaseButton variant="primary" size="md" class="ml-10">
          Join the Waitlist
        </BaseButton>
      </div>
    ...
    >
      <div
        v-if="isMenuOpen"
        id="mobile-menu"
        class="fixed left-0 top-0 z-[100] h-full w-full max-w-sm bg-white lg:hidden shadow-2xl"
        role="dialog"
        aria-modal="true"
