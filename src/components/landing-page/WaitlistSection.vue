          ...
          <div class="rounded-md bg-white p-6 text-left shadow-sm transition hover:shadow-md">
            ...
            <div class="flex flex-col gap-2">
              <Card
                ...
                :key="idx"
                class="flex flex-row items-center justify-between rounded-md border-0 bg-white p-2 shadow-none transition"
              >
                <div class="flex items-center gap-3">
                  <div class="flex h-10 w-10 items-center justify-center rounded-full bg-[#F1A75F]">
