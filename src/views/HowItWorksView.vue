  ...
  <div class="flex min-h-screen flex-col bg-[#F5EFE8]">
    ...
    <main class="flex flex-1 items-center justify-center px-6 py-16">
      <section class="w-full max-w-5xl rounded-4xl bg-white p-10 shadow-2xl">
        <p class="text-xs font-semibold uppercase tracking-[0.3em] text-[#C27A3F]">How it works</p>
        <h1 class="mt-2 text-3xl font-bold text-[#1D140B]">From sign-up to signals in four steps</h1>
        <div class="mt-10 grid gap-6 md:grid-cols-2">
          <article class="rounded-3xl border border-[#F1E4D7] p-6">
            ...
            <p class="mt-2 text-sm text-[#705C4A]">
              Share your industry, jurisdictions, and primary compliance needs so we can tailor feeds to you.
            </p>
          </article>
          <article class="rounded-3xl border border-[#F1E4D7] p-6">
            <p class="text-xs font-semibold text-[#BE8554]">Step 2</p>
            <h2 class="mt-2 text-xl font-semibold text-[#1D140B]">Verify your access</h2>
            <p class="mt-2 text-sm text-[#705C4A]">Complete OTP verification so we can keep your workspace secure.</p>
          </article>
          <article class="rounded-3xl border border-[#F1E4D7] p-6">
            <p class="text-xs font-semibold text-[#BE8554]">Step 3</p>
            <h2 class="mt-2 text-xl font-semibold text-[#1D140B]">Onboard in minutes</h2>
            <p class="mt-2 text-sm text-[#705C4A]">
              Add your projects and stakeholders, then choose the regulators and watchlists to monitor.
            </p>
          </article>
          <article class="rounded-3xl border border-[#F1E4D7] p-6">
            ...
            <p class="mt-2 text-sm text-[#705C4A]">
              Sit back while Legal Watchdog delivers prioritised insights, summaries, and alerts to your dashboard.
            </p>
          </article>
        </div>
