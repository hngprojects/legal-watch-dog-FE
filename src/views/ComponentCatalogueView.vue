...
const navigation = [
  { id: 'buttons', label: 'Buttons', hint: 'Variants & states' },
]
  ...
  <div class="min-h-screen bg-gradient-to-br from-[#f8f5f1] via-white to-[#eef2f7] text-gray-900">
    <div class="mx-auto grid max-w-6xl gap-8 px-4 py-10 lg:grid-cols-[240px_1fr] lg:px-8">
      <aside class="lg:sticky lg:top-8">
        <div class="mb-4 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-gray-500">
          <Sparkles class="h-4 w-4 text-accent-main" />
          Workbench
        </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
          <div class="flex items-start justify-between gap-2">
            <div>
              <p class="text-xs font-medium uppercase tracking-[0.18em] text-gray-500">Component Catalogue</p>
          ...
          <nav class="flex flex-col gap-2 text-sm">
            ...
            >
              <span class="font-semibold text-gray-800 group-hover:text-accent-main">
                {{ item.label }}
              </span>
      ...
      <main class="space-y-12 pb-12">
        <section id="buttons" class="scroll-mt-20 space-y-4">
          <div class="flex items-center gap-3">
            <Badge variant="outline" class="uppercase tracking-[0.18em]">Buttons</Badge>
