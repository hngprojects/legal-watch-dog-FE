  ...
  <div v-if="blogPost" class="min-h-screen bg-gray-50 py-16">
    <div class="mx-auto max-w-4xl px-6">
      ...
      <section class="pt-16 pb-20 text-center">
        ...
        >
        Stay ahead of legal changes by <span class="text-[#F2AB6D]"> subscribing</span>  to our newsletter.
        </TypographyHeading>

        <TypographyText class="mx-auto max-w-2xl text-center text-gray-600">
          Join our newsletter to get early alerts on regulation updates, price fluctuations, and compliance insights that matter to your business.
        </TypographyText>
