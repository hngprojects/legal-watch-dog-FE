...
const acceptInvite = async () => {
  ...
  try {
    ...
    await Swal.fire('Invitation accepted', result || 'You now have access to this organization.', 'success')
...
<template>
  <main class="min-h-screen flex items-center justify-center bg-[#f8f7f5] px-6 py-12">
    <div class="w-full max-w-md rounded-2xl bg-white p-10 text-center shadow-md ring-1 ring-gray-100">
      <div class="mx-auto mb-4 h-12 w-12 animate-spin rounded-full border-4 border-[#401903]/20 border-t-[#401903]" v-if="loading"></div>
