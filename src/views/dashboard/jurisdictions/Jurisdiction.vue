  ...
  <main class="min-h-screen flex-1 bg-[#F8F7F5] px-6 py-8 lg:px-10 lg:py-12">
    ...
    <div v-else class="mx-auto max-w-6xl space-y-6 lg:space-y-8">
      ...
      <section class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
        ...
        <template v-else>
          <div class="flex flex-col gap-3">
            <p class="text-xs font-semibold uppercase tracking-[0.15em] text-[#C17A3F]">
              Jurisdiction
            </p>
      ...
      <section class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
        ...
        <p
          class="mt-4 whitespace-pre-line rounded-xl bg-[#F8F1EA] p-4 text-sm leading-6 text-[#3D2E1F]"
        >
        ...
        <div v-if="activeTab === 'output'" class="p-6">
          ...
          <div v-if="outputItems.length" class="space-y-3">
            ...
            >
              ...
              <p
                v-if="item.detail"
                class="mt-2 whitespace-pre-line text-sm leading-6 text-[#4B5563]"
              >
                {{ item.detail }}
              </p>
            </article>
