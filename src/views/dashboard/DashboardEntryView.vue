...
<template>
  <section class="flex min-h-[60vh] items-center justify-center bg-gray-50 px-4">
    <div
      class="max-w-md rounded-2xl bg-white px-6 py-10 text-center shadow-sm ring-1 ring-gray-100"
    >
      <div
        class="mx-auto mb-4 h-12 w-12 animate-spin rounded-full border-4 border-gray-200 border-t-[#401903]"
      ></div>
