          ...
          <form @submit.prevent="handleCreateAccount" class="space-y-5">
            ...
            <div class="relative">
              ...
              <button
                ...
                class="absolute top-1/2 right-4 -translate-y-1/2 text-gray-400 hover:text-gray-600 focus:outline-none"
              >
                <svg
                  v-if="!showPassword"
                  class="h-5 w-5"
            ...
            <button
              type="submit"
              class="w-full rounded-md bg-[#3C2610] py-3.5 text-sm font-bold tracking-wide text-white uppercase shadow-sm transition-colors hover:bg-[#2a1b0b]"
            >
              Signup
            </button>
            ...
            <div class="space-y-3">
              <button
                type="button"
                class="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white py-3 transition-colors hover:bg-gray-50"
              >
